...
//  });
  ...
  return (
    <main className='w-[300px] h-[439px] px-[24px] pb-[20px] pt-[18px] inline-flex justify-center bg-transparent rounded-[32px] flex-col space-y-6 shadow-lg'>
 ...
 //       onClick={stopScreenRecord}
        className='bg-[#928FAB] text-white rounded-[12px]'
      >
        Stop Recording
      </Button>
    </main>
